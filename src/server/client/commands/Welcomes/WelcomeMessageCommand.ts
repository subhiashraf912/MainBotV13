...
export default class WelcomeMessageCommand extends BaseCommand {
  ...
  async run(client: DiscordClient, message: Message, args: Array<string>) {
    ...
    if (!args[0]) {
      message.reply("You need to send the text of the welcome message!");
      return;
    }
    ...
    welcomeMessage
      ? message.reply("The welcome message text has been updated!")
      : message.reply("The welcome message text has been rested to default!");
  }
}
